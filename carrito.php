  ...
  <div class="body">
    ...
    <div class="main-content">
      <div class="page-content">
        ...
        <div class=""><h2>TOTAL A PAGAR:<span id="total"></span></h2></div>
        <h3>Datos de pago</h3>
        <div class="">Banco: ING</div>
        <div class="">Nº de cuenta: ES12 1234 1234 12 1234567890</div>
        <div class="">Concepto: compra fidesa</div>
        <div class="">*Enviar justificante de pago a la dirección fidisaf@gmail.com y al número +34 681173172.</div>
      </div>
    </div>
  </div>
  <footer class="footer">
        ...
        for (var i = 0; i < data.datos.length; i++) {
          ...
          '<div class="item">'+
              ...
              '<div class="detallepedido">'+
                  ...
                  '<h4>'+data.datos[i].telusuarioped+'</h4>'+
