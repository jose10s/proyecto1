  ...
  <div class="body">
    ...
    <div class="main-content">
      <div class="page-content">
        <div class="">
          <form class="" action="consultas/login.php" method="post">
            <h3>INICIAR SESION</h3>
            <input type="text" name="emausuario" value="" placeholder="correo">
            <input type="password" name="passusuario" value="" placeholder="contraseña">
            <?php
            if (isset($_GET['e'])) {
              switch ($_GET['e']) {
                case '1':
